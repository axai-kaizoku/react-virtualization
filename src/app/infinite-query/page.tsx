import { InfiniteComments } from "./_components/infinite-comments"
    ...
    <section className="max-w-4xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="mb-4">
          ...
          Query&apos;s{" "}
          <code className="text-neutral-100 bg-neutral-700 px-1 rounded">
            useInfiniteQuery
          </code>{" "}
      ...
      <div className="mt-8 space-y-4 bg-neutral-800 p-6 rounded-lg">
