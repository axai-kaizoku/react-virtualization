...
import { FetchWithUseEffect } from "./_components/fetch-with-use-effect"
import { FetchWithUseEffectFixed } from "./_components/fetch-with-use-effect-fixed"
...
export default function Page() {
  ...
  return (
    <section className="max-w-5xl mx-auto p-6">
      ...
      <div className="mt-8 space-y-4 bg-neutral-800 text-neutral-100 p-6 rounded-lg">
