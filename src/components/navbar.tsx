...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white border-b text-neutral-900 border-gray-200 shadow-sm">
                ...
                <PopoverTrigger asChild>
                  <div className="relative">
                    <Input
                      ...
                      className="w-full pl-10 pr-4 text-white py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-apple-darkGray"
                      value={searchQuery}
                    ...
                    <div className="flex flex-wrap gap-2 p-1">
                      {popularSearches.map((search) => (
                        <button
                          ...
                          className="bg-gray-100 hover:bg-gray-200 text-gray-900 px-3 py-1.5 rounded-full text-xs text-apple-darkGray transition-colors"
                        >
                          {search}
                        </button>
                      ))}
